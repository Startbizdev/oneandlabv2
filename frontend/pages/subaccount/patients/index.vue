<template>
  <div class="space-y-4">
    ...
    >
      <template #actions>
        <UButton color="primary" icon="i-lucide-plus" to="/subaccount/patients/new">
          Ajouter un patient
        </UButton>
      </template>
    </TitleDashboard>
    ...
    >
      <template #actions>
        <UButton to="/subaccount/patients/new" color="primary" icon="i-lucide-plus">Ajouter un patient</UButton>
      </template>
    </UEmpty>
