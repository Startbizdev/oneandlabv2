        ...
        >
          <div class="space-y-4">
            ...
            <div v-if="review.response" class="pt-3 border-t border-gray-200 dark:border-gray-700">
              ...
              <p class="text-sm text-gray-700 dark:text-gray-300 p-3 rounded-lg bg-primary-50 dark:bg-primary-900/20 border-l-4 border-primary-500 dark:border-primary-400">
                {{ review.response }}
              </p>
            </div>
