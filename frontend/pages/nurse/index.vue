<template>
  <div class="nurse-dashboard-page space-y-6 lg:space-y-8">
    <TitleDashboard
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
      ...
      <section class="flex flex-col gap-3">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
          ...
          >
            <template #actions>
              <UButton to="/nurse/appointments/new" color="primary" variant="solid">
                Planifier un RDV
              </UButton>
            </template>
          </UEmpty>
            ...
            <li v-for="patient in patients.slice(0, 6)" :key="patient.id">
              ...
              >
                ...
                <div class="flex items-center gap-2 flex-shrink-0">
                  <UButton
                    :to="`/nurse/appointments/new?patient_id=${patient.id}`"
                    color="primary"
                    variant="soft"
...
useHead({ title: 'Tableau de bord – Infirmier' });
