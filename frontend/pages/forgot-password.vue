    ...
    <div class="mx-auto flex w-full max-w-[380px] flex-1 flex-col justify-center">
      ...
      <div class="rounded-xl border border-gray-200/90 bg-white px-5 py-6 dark:border-gray-800 dark:bg-gray-950">
        <template v-if="!sent">
          ...
          <p class="mt-1 text-[13px] text-gray-500">Nous vous envoyons un lien et un code par email.</p>
        ...
        <template v-else>
          <h1 class="text-[15px] font-semibold text-gray-900 dark:text-gray-100">Regardez votre boîte mail</h1>
          <p class="mt-2 text-[13px] leading-relaxed text-gray-500">
            Si un compte existe à cette adresse, vous recevrez un lien et un code.
          </p>
