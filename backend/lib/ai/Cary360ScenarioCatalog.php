...
final class Cary360ScenarioCatalog
{
    public static function chatScenarios(): array
    {
        ...
        return [
            ...
            [
                'id' => 'p1_staff_booking_nurse',
                'phase' => 1,
                'label' => 'Infirmier — RDV pour un patient (pas proche)',
                'message' => 'Je veux planifier un pansement demain pour mon patient Marie.',
                'expect_focus' => CaryContextFocus::GENERAL,
                'role' => 'nurse',
                'forbidden' => array_merge($textForbidden, ['pour vous ou pour un proche', 'pour vous-même']),
                'min_length' => 15,
                'soft_contains' => ['patient', 'marie', 'pansement', 'demain'],
            ],
            [
                'id' => 'p1_next_rdv',
                'phase' => 1,
